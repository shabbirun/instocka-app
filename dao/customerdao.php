...
class customerdao{
    ...
    public function insertProduct($data,$user_login_id){
        ...
        $Sql="INSERT INTO product(product_title,customer_id,product_id,option_sku,sent,user_login_id,created_at) VALUES('".$data['product_title']."','".$data['customer_id']."','".$data['product_id']."','".$data['option_sku']."','".$data['sent']."','".$user_login_id."',".$data['date'].")";
        mysqli_query($this->con,$Sql);
    }
    ...
    public function validateProduct($product,$user_login_id){
        $bool = false;
        $Sql = "SELECT id FROM product WHERE product_id='".$product['product_id']."' AND option_sku='".$product['option_sku']."' AND customer_id='".$product['customer_id']."' AND user_login_id='".$user_login_id."'";
        //echo $Sql;
    ...
    public function updateProduct($data,$user_login_id){
        $data['product_title'] = mysqli_real_escape_string($this->con, $data['product_title']);
        $Sql="UPDATE product SET product_title='".$data['product_title']."',customer_id='".$data['customer_id']."',product_id='".$data['product_id']."',option_sku='".$data['option_sku']."',sent='".$data['sent']."', updated_at=".$data['date']." WHERE product_id='".$data['product_id']."' AND customer_id='".$data['customer_id']."' AND user_login_id='".$user_login_id."' AND option_sku='".$data['option_sku']."'";
        mysqli_query($this->con,$Sql);
    }
