...
<?php
$pendingNotify = (!empty($pendingNotify))?$pendingNotify:null;
?>
<body>
<div id="wrapper">
    <div class="wrapper">
    ...
    <?php include 'view/panel_head.php';?>
        ...
        <div class="row" style="margin-top: 5px;">
            <form method="post" action="<?php echo BASE_URL?>admin-pending">
        ...
        <div class="panel-heading text-center"><strong>Product with pending notifications</strong></div>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-fix">
                ...
                <?php
                try{
                    if(empty($pendingNotify)){ throw new Exception('Error');}
                    $c = 0;
                    while($resp = $pendingNotify->fetch_object()){
                    $c++;
                ?>
                <tr>
                ...
                <?php
                    ...
                    if($c == 0){ echo '<p class="text-center">No Pendings</p>';}
                }catch(Exception $ex){
