...
class Client
{
	...
	**/
    ...
    public static function verify($signedRequest, $clientSecret)
    {
    	...
    	if (self::secureCompare($signature, $expectedSignature)) {
    ...
    private static function secureCompare($str1, $str2)
    {
    	$res = $str1 ^ $str2;
